...
import { queryOrderList, getOrderDetail, setStatusOrder, reNotify, manualRefund, getProvince, setRefund, checkOrder } from '@/api';
    ...
    data() {
        return {
            ...
            columnList: [
                ...
                { prop: 'out_trade_no', label: '商户订单号-商户号', width: 215, show: true },
